...
CFTSAD_METHOD_CONFIGS = {
    ...
    "segment": {
        ...
        "segment_length_factors": (1.0, 1.5, 2.0, 3.0),
        "segment_top_k_donors": 8,
        "segment_context_width": 2,
        "segment_crossfade_width": 3,
        "segment_allow_pair_search": True,
        "segment_max_pair_groups": 4,
        "segment_localizer_top_fraction": 0.1,
        "segment_localizer_padding": 2,
        "segment_normalize_errors": True,
        "fallback_methods": ("motif", "nearest", "genetic"),
    },
    "motif": {
        "motif_top_k": 5,
        "motif_n_segments": 4,
        "motif_length_factors": (1.0, 1.5, 2.0, 3.0),
        "motif_context_weight": 0.2,
        "motif_use_affine_fit": True,
        "motif_allow_pair_search": True,
        "motif_max_pair_groups": 4,
        "motif_localizer_top_fraction": 0.1,
        "motif_localizer_padding": 2,
        "motif_normalize_errors": True,
