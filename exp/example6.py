...
if __name__ == "__main__":
    ...
    cf_method = SegmentClampToNormalBoundsCF(
        model=model,
        threshold=threshold,
    ...
    if result is None:
        ...
        save_path = os.path.join(output_dir, "segmented_clamp_normal_plot.png")
        ...
        plot_counterfactual(
            ...
            title=f"Clamp to Normal Bounds Counterfactual\n"
        ...
        json_path = os.path.join(cfg.log_dir, "segmented_clamp_normal_summary.json")
