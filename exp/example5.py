...
if __name__ == "__main__":
    ...
    # =====================================================
    print("\n" + "=" * 70)
    print("🔍 COUNTERFACTUAL GENERATION - GROWING SPHERES")
    print("=" * 70 + "\n")
    ...
    cf_method = SegmentGeneticBlendCF(
        model=model,
        threshold=threshold,
        ...
        pop_size=32,
        generations=40,
        alpha_grid=(0.15, 0.25, 0.35, 0.5, 0.65, 0.8),
        lam_dist=0.35,
        lam_smooth=0.2,
    )
    ...
    if result is None:
        ...
        if "segment" in result["meta"]:
            print(f"  Segment:       {result['meta']['segment']}")
        ...
        # 1. Define the save path (Missing in your snippet)
        output_dir = "experiment_run"
        os.makedirs(output_dir, exist_ok=True)
        save_path = os.path.join(output_dir, "segmented_genetic_blend_plot.png")
        ...
        plot_counterfactual(
            ...
            title=f"Segmented Genetic Blend Counterfactual\n"
        ...
        # 3. CONSOLIDATED STORAGE (Per your saved preference)
        import json
        ...
        combined_results = {
            ...
            "counterfactual_meta": {
                ...
                "evals": result["meta"]["evals"],
                "method": "Segmented Genetic Blend",
            },
            "evaluation_metrics": {
                k: (
                    float(v)
        ...
        json_path = os.path.join(cfg.log_dir, "segmented_genetic_blend_summary.json")
        ...
        print("done bro segmentredgrowingcf")
