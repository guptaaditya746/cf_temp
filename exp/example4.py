...
if __name__ == "__main__":
    ...
    cf_method = SegmentGrowingSpheresCF(
        model=model,
        threshold=threshold,
    ...
    if result is None:
        ...
        save_path = os.path.join(output_dir, "segmented_growing_cf_plot.png")
        ...
        plot_counterfactual(
            ...
            title=f"Segmented Growing Counterfactual\n"
        ...
        json_path = os.path.join(cfg.log_dir, "segmented_growing_cf_summary.json")
